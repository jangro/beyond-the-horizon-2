...
// // 1.21.1 — preferred (components)
// const AETHER_CITADEL_MAP = Item.of('supplementaries:cartographers_quill').withComponents({
//   'minecraft:custom_name': { translate: 'filled_map.aether_citadel' },
//   'minecraft:custom_data': {
//     decoration: 'filled_map.aether_citadel',
//     maxSearchRadius: 100,
//     skinKnown: 1, // was 1b; byte suffix isn’t used in components JSON
//     targetStructure: 'aether_villages:olympic_citadel',
//     zoomLevel: 2
//   }
// });
...
// const DRAGON_EGG_AETHER = Item.of('dmr:dragon_egg[dmr:dragon_breed="aether"]');
// const DRAGON_EGG_AMETHYST = Item.of('dmr:dragon_egg[dmr:dragon_breed="amethyst"]');
// const DRAGON_EGG_END = Item.of('dmr:dragon_egg[dmr:dragon_breed="end"]');
// const DRAGON_EGG_FIRE = Item.of('dmr:dragon_egg[dmr:dragon_breed="fire"]');
// const DRAGON_EGG_FOREST = Item.of('dmr:dragon_egg[dmr:dragon_breed="forest"]');
// const DRAGON_EGG_GHOST = Item.of('dmr:dragon_egg[dmr:dragon_breed="ghost"]');
// const DRAGON_EGG_ICE = Item.of('dmr:dragon_egg[dmr:dragon_breed="ice"]');
// const DRAGON_EGG_LUSH = Item.of('dmr:dragon_egg[dmr:dragon_breed="lush"]');
// const DRAGON_EGG_NETHER = Item.of('dmr:dragon_egg[dmr:dragon_breed="nether"]');
// const DRAGON_EGG_SCULK = Item.of('dmr:dragon_egg[dmr:dragon_breed="sculk"]');
// const DRAGON_EGG_WATER = Item.of('dmr:dragon_egg[dmr:dragon_breed="water"]');
