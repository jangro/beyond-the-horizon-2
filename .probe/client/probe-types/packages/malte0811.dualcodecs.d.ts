 ...
 */
export type $DualMapCodec$$Type<S, T> = ({"streamCodec"?: $StreamCodec$$Type<(any), (any)>, "mapCodec"?: $MapCodec$$Type<(any)>}) | ([streamCodec?: $StreamCodec$$Type<(any), (any)>, mapCodec?: $MapCodec$$Type<(any)>]);
/**
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DualCodec$$Type<S, T> = ({"codec"?: $Codec$$Type<(any)>, "streamCodec"?: $StreamCodec$$Type<(any), (any)>}) | ([codec?: $Codec$$Type<(any)>, streamCodec?: $StreamCodec$$Type<(any), (any)>]);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
