...
ServerEvents.recipes(event => {
  ...
  if (Platform.isLoaded('ae2')) {
    eio.alloy_smelting({ id: 'ae2:fluix_crystal', count: 2 }, [{ item: 'ae2:charged_certus_quartz_crystal', count: 1 }, { tag: 'c:dusts/redstone', count: 1 }, { tag: 'c:gems/quartz', count: 1 }], 3200, 0.3).id(`${ID_PREFIX}alloy_smelting/fluix_crystal`);
  ...
  if (Platform.isLoaded('create')) {
    eio.alloy_smelting({ id: 'create:brass_ingot', count: 2 }, [{ tag: 'c:ingots/copper', count: 1 }, { tag: 'c:ingots/zinc', count: 1 }], 3200, 0.3).id(`${ID_PREFIX}alloy_smelting/brass_ingot`);
    eio.sag_milling('#c:crops/wheat', [{ item: 'create:wheat_flour', chance: 1.0 }, { item: 'create:wheat_flour', count: 2, chance: 0.25 }, { item: 'minecraft:wheat_seeds', chance: 0.25 }], 2400, 'none').id(`${ID_PREFIX}sag_milling/wheat`);
  }
  ...
  if (Platform.isLoaded('immersiveengineering')) {
    eio.alloy_smelting({ id: 'immersiveengineering:ingot_electrum' }, [{ tag: 'c:dusts/electrum', count: 1 }], 1500, 1.0).id(`${ID_PREFIX}alloy_smelting/electrum_ingot_from_dust`);
    eio.alloy_smelting({ id: 'immersiveengineering:ingot_constantan', count: 2 }, [{ tag: 'c:ingots/copper', count: 1 }, { tag: 'c:ingots/nickel', count: 1 }], 3200, 0.3).id(`${ID_PREFIX}alloy_smelting/constantan_ingot`);
    eio.alloy_smelting({ id: 'immersiveengineering:ingot_electrum', count: 2 }, [{ tag: 'c:ingots/gold', count: 1 }, { tag: 'c:ingots/silver', count: 1 }], 3200, 0.3).id(`${ID_PREFIX}alloy_smelting/electrum_ingot`);
  }
