...
import {$Schools, $Schools$$Type} from "moe.wolfgirl.probejs.generated.registry.irons_spellbooks.Schools"
...
import {$EntityType, $EntityType$$Type} from "moe.wolfgirl.probejs.generated.registry.minecraft.EntityType"
...
import {$Spells, $Spells$$Type} from "moe.wolfgirl.probejs.generated.registry.irons_spellbooks.Spells"

declare global {
export namespace StartupEvents {
function registry(type: "armor_material", handler: (event: $ArmorMaterial) => void): void
function registry(type: "irons_spellbooks:spells", handler: (event: $Spells) => void): void
...
function registry(type: "irons_spellbooks:schools", handler: (event: $Schools) => void): void
