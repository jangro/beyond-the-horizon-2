...
import {$KubeJSCuriosEventJS$registerRenderer, $KubeJSCuriosEventJS$registerRenderer$$Type} from "net.zhaiji.kubejscurios.kubejs.KubeJSCuriosEventJS$registerRenderer"
...
function registerRenderer(handler: (event: $KubeJSCuriosEventJS$registerRenderer) => void): void
