declare module "net.lyof.phantasm.item.custom.ShatteredPendantItem" {
...
export class $ShatteredPendantItem extends $Item {
...
public static "canSeeSky"(arg0: $BlockPos$$Type, arg1: $Level$$Type): boolean
 ...
 */
export type $ShatteredPendantItem$$Type = ($ShatteredPendantItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ShatteredPendantItem_ = $ShatteredPendantItem$$Type;
}}
declare module "net.lyof.phantasm.world.feature.BoulderFeature" {
...
import {$BoulderFeatureConfig, $BoulderFeatureConfig$$Type} from "net.lyof.phantasm.world.feature.config.BoulderFeatureConfig"
...
static readonly "INSTANCE": $Feature<($BoulderFeatureConfig)>
...
constructor(arg0: $Codec$$Type<($BoulderFeatureConfig$$Type)>)

public "move"(arg0: $BlockPos$$Type, arg1: $Direction$$Type, arg2: $Direction$$Type, arg3: $RandomSource$$Type, arg4: $WorldGenLevel$$Type): $BlockPos
public "place"(arg0: $FeaturePlaceContext$$Type<($BoulderFeatureConfig$$Type)>): boolean
public "spike"(arg0: $List$$Type<($BlockPos$$Type)>, arg1: $BlockPos$$Type, arg2: integer, arg3: boolean): void
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
declare module "net.lyof.phantasm.block.custom.HangingPlantBlock" {
...
export class $HangingPlantBlock extends $Block {
...
constructor(arg0: $BlockBehaviour$Properties$$Type, arg1: $TagKey$$Type<($Block)>, arg2: $VoxelShape$$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $HangingPlantBlock$$Type = ($HangingPlantBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $HangingPlantBlock_ = $HangingPlantBlock$$Type;
}}
declare module "net.lyof.phantasm.block.custom.ModRotatedPillarBlock" {
...
export class $ModRotatedPillarBlock extends $RotatedPillarBlock {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModRotatedPillarBlock$$Type = ($ModRotatedPillarBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ModRotatedPillarBlock_ = $ModRotatedPillarBlock$$Type;
}}
declare module "net.lyof.phantasm.block.custom.signs.ModWallHangingSignBlock" {
...
declare module "net.lyof.phantasm.item.custom.ChoralArrowItem" {
import {$BlockHitResult, $BlockHitResult$$Type} from "net.minecraft.world.phys.BlockHitResult"
import {$Map, $Map$$Type} from "java.util.Map"
import {$ItemStack, $ItemStack$$Type} from "net.minecraft.world.item.ItemStack"
import {$List, $List$$Type} from "java.util.List"
...
export class $ChoralArrowItem extends $ArrowItem {
static readonly "BASE_ATTACK_DAMAGE_ID": $ResourceLocation
static readonly "DEFAULT_MAX_STACK_SIZE": integer
 "descriptionId": StringJS
static readonly "MAX_BAR_WIDTH": integer
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ChoralArrowItem$$Type = ($ChoralArrowItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ChoralArrowItem_ = $ChoralArrowItem$$Type;
}}
declare module "net.lyof.phantasm.world.feature.config.DralgaeFeatureConfig" {
import {$Codec, $Codec$$Type} from "com.mojang.serialization.Codec"
...
export class $DralgaeFeatureConfig extends $Record implements $FeatureConfiguration {
static "CODEC": $Codec<($DralgaeFeatureConfig)>

constructor(size: $IntProvider$$Type, stem: $BlockStateProvider$$Type, fruit: $BlockStateProvider$$Type)

public "size"(): $IntProvider
public "equals"(arg0: any): boolean
public "toString"(): StringJS
public "hashCode"(): integer
public "fruit"(): $BlockStateProvider
public "stem"(): $BlockStateProvider
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DralgaeFeatureConfig$$Type = ({"fruit"?: $BlockStateProvider$$Type, "stem"?: $BlockStateProvider$$Type, "size"?: $IntProvider$$Type}) | ([fruit?: $BlockStateProvider$$Type, stem?: $BlockStateProvider$$Type, size?: $IntProvider$$Type]);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DralgaeFeatureConfig_ = $DralgaeFeatureConfig$$Type;
}}
declare module "net.lyof.phantasm.world.feature.CrystalSpikeFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
import {$ProbabilityFeatureConfiguration, $ProbabilityFeatureConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.ProbabilityFeatureConfiguration"
import {$Feature, $Feature$$Type} from "net.minecraft.world.level.levelgen.feature.Feature"
import {$CrystalSpikeFeatureConfig, $CrystalSpikeFeatureConfig$$Type} from "net.lyof.phantasm.world.feature.config.CrystalSpikeFeatureConfig"
import {$BlockColumnConfiguration, $BlockColumnConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.BlockColumnConfiguration"
import {$FossilFeatureConfiguration, $FossilFeatureConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.FossilFeatureConfiguration"
import {$LargeDripstoneConfiguration, $LargeDripstoneConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.LargeDripstoneConfiguration"
import {$ColumnFeatureConfiguration, $ColumnFeatureConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.ColumnFeatureConfiguration"
...
export class $CrystalSpikeFeature extends $Feature<($CrystalSpikeFeatureConfig)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
static readonly "NETHER_FOREST_VEGETATION": $Feature<($NetherForestVegetationConfig)>
static readonly "WEEPING_VINES": $Feature<($NoneFeatureConfiguration)>
static readonly "INSTANCE": $Feature<($CrystalSpikeFeatureConfig)>
static readonly "LAKE": $Feature<($LakeFeature$Configuration)>
static readonly "TWISTING_VINES": $Feature<($TwistingVinesConfig)>
static readonly "END_PLATFORM": $Feature<($NoneFeatureConfiguration)>
static readonly "HUGE_RED_MUSHROOM": $Feature<($HugeMushroomFeatureConfiguration)>
...
constructor(arg0: $Codec$$Type<($CrystalSpikeFeatureConfig$$Type)>)

public "place"(arg0: $FeaturePlaceContext$$Type<($CrystalSpikeFeatureConfig$$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
declare module "net.lyof.phantasm.block.custom.DirectionalBlock" {
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$Map, $Map$$Type} from "java.util.Map"
import {$Direction, $Direction$$Type} from "net.minecraft.core.Direction"
...
public "getPlacementState"(arg0: $LevelReader$$Type, arg1: $BlockPos$$Type): $BlockState
 ...
 */
declare global {
export type $DirectionalBlock_ = $DirectionalBlock$$Type;
}}
declare module "net.lyof.phantasm.world.feature.config.BoulderFeatureConfig" {
import {$Codec, $Codec$$Type} from "com.mojang.serialization.Codec"
import {$ConfiguredFeature, $ConfiguredFeature$$Type} from "net.minecraft.world.level.levelgen.feature.ConfiguredFeature"
import {$IntProvider, $IntProvider$$Type} from "net.minecraft.util.valueproviders.IntProvider"
import {$BlockStateProvider, $BlockStateProvider$$Type} from "net.minecraft.world.level.levelgen.feature.stateproviders.BlockStateProvider"
...
static "CODEC": $Codec<($BoulderFeatureConfig)>

constructor(size: $IntProvider$$Type, block: $BlockStateProvider$$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BoulderFeatureConfig$$Type = ({"size"?: $IntProvider$$Type, "block"?: $BlockStateProvider$$Type}) | ([size?: $IntProvider$$Type, block?: $BlockStateProvider$$Type]);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
...
declare module "net.lyof.phantasm.block.custom.SubwooferBlock" {
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$Block, $Block$$Type} from "net.minecraft.world.level.block.Block"
import {$Level, $Level$$Type} from "net.minecraft.world.level.Level"
...
export class $SubwooferBlock extends $Block {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
static readonly "CODEC": $MapCodec<($Block)>
static readonly "UPDATE_NEIGHBORS": integer
...
public static "canPush"(arg0: $Entity$$Type): boolean
public "getStateForPlacement"(arg0: $BlockPlaceContext$$Type): $BlockState
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $SubwooferBlock$$Type = ($SubwooferBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $SubwooferBlock_ = $SubwooferBlock$$Type;
}}
declare module "net.lyof.phantasm.mixin.access.EndGatewayBlockEntityAccessor" {
import {$Level, $Level$$Type} from "net.minecraft.world.level.Level"
import {$BlockPos, $BlockPos$$Type} from "net.minecraft.core.BlockPos"

export interface $EndGatewayBlockEntityAccessor {

}

export namespace $EndGatewayBlockEntityAccessor {
function getExitPos(arg0: $Level$$Type, arg1: $BlockPos$$Type): $BlockPos
const probejs$$marker: never
}
export class $EndGatewayBlockEntityAccessor$$Static implements $EndGatewayBlockEntityAccessor {


static "getExitPos"(arg0: $Level$$Type, arg1: $BlockPos$$Type): $BlockPos
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $EndGatewayBlockEntityAccessor$$Type = ($EndGatewayBlockEntityAccessor);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $EndGatewayBlockEntityAccessor_ = $EndGatewayBlockEntityAccessor$$Type;
}}
declare module "net.lyof.phantasm.block.custom.DragonMintBlock" {
import {$BlockHitResult, $BlockHitResult$$Type} from "net.minecraft.world.phys.BlockHitResult"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$ItemStack, $ItemStack$$Type} from "net.minecraft.world.item.ItemStack"
...
export class $DragonMintBlock extends $DoublePlantBlock implements $BonemealableBlock {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
...
public static "getOtherHalf"(arg0: $LevelReader$$Type, arg1: $BlockPos$$Type, arg2: $BlockState$$Type): $BlockState
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DragonMintBlock$$Type = ($DragonMintBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DragonMintBlock_ = $DragonMintBlock$$Type;
}}
declare module "net.lyof.phantasm.block.custom.signs.ModStandingSignBlock" {
import {$WoodType, $WoodType$$Type} from "net.minecraft.world.level.block.state.properties.WoodType"
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
...
declare module "net.lyof.phantasm.effect.ModMobEffect" {
...
export class $ModMobEffect extends $MobEffect {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModMobEffect$$Type = ($ModMobEffect);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ModMobEffect_ = $ModMobEffect$$Type;
}}
declare module "net.lyof.phantasm.block.custom.HangingFruitBlock" {
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$HangingPlantBlock, $HangingPlantBlock$$Type} from "net.lyof.phantasm.block.custom.HangingPlantBlock"
import {$Block, $Block$$Type} from "net.minecraft.world.level.block.Block"
import {$Level, $Level$$Type} from "net.minecraft.world.level.Level"
import {$BlockBehaviour$Properties, $BlockBehaviour$Properties$$Type} from "net.minecraft.world.level.block.state.BlockBehaviour$Properties"
import {$Holder, $Holder$$Type} from "net.minecraft.core.Holder"
...
export class $HangingFruitBlock extends $HangingPlantBlock implements $BonemealableBlock {
static readonly "HAS_FRUIT": $BooleanProperty
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
static readonly "CODEC": $MapCodec<($Block)>
 "shape": $VoxelShape
...
constructor(arg0: $BlockBehaviour$Properties$$Type, arg1: $TagKey$$Type<($Block)>, arg2: $VoxelShape$$Type, arg3: StringJS)
...
declare module "net.lyof.phantasm.block.custom.signs.ModWallSignBlock" {
import {$WoodType, $WoodType$$Type} from "net.minecraft.world.level.block.state.properties.WoodType"
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
...
declare module "net.lyof.phantasm.world.feature.SingleBlockFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
import {$LargeDripstoneConfiguration, $LargeDripstoneConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.LargeDripstoneConfiguration"
import {$ColumnFeatureConfiguration, $ColumnFeatureConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.ColumnFeatureConfiguration"
import {$SingleBlockFeatureConfig, $SingleBlockFeatureConfig$$Type} from "net.lyof.phantasm.world.feature.config.SingleBlockFeatureConfig"
import {$FeaturePlaceContext, $FeaturePlaceContext$$Type} from "net.minecraft.world.level.levelgen.feature.FeaturePlaceContext"
import {$SpikeConfiguration, $SpikeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpikeConfiguration"
import {$HugeFungusConfiguration, $HugeFungusConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.HugeFungusConfiguration"
import {$TreeConfiguration, $TreeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.TreeConfiguration"
...
export class $SingleBlockFeature extends $Feature<($SingleBlockFeatureConfig)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
static readonly "NETHER_FOREST_VEGETATION": $Feature<($NetherForestVegetationConfig)>
static readonly "WEEPING_VINES": $Feature<($NoneFeatureConfiguration)>
static readonly "INSTANCE": $Feature<($SingleBlockFeatureConfig)>
static readonly "LAKE": $Feature<($LakeFeature$Configuration)>
static readonly "TWISTING_VINES": $Feature<($TwistingVinesConfig)>
static readonly "END_PLATFORM": $Feature<($NoneFeatureConfiguration)>
static readonly "HUGE_RED_MUSHROOM": $Feature<($HugeMushroomFeatureConfiguration)>
...
constructor(arg0: $Codec$$Type<($SingleBlockFeatureConfig$$Type)>)

public "place"(arg0: $FeaturePlaceContext$$Type<($SingleBlockFeatureConfig$$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
declare module "net.lyof.phantasm.world.gen.SamplerHooks" {
...
export interface $SamplerHooks {
 ...
 "getSeed"(): long
 "getEndBiomesSampler"(): $ImprovedNoise
set "seed"(value: long)
get "seed"(): long
get "endBiomesSampler"(): $ImprovedNoise
}

export namespace $SamplerHooks {
const probejs$$marker: never
}
export class $SamplerHooks$$Static implements $SamplerHooks {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $SamplerHooks$$Type = ($SamplerHooks);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $SamplerHooks_ = $SamplerHooks$$Type;
}}
declare module "net.lyof.phantasm.mixin.access.NoiseGeneratorSettingsAccess" {
...
export interface $NoiseGeneratorSettingsAccess {

 "addSurfaceRule"(arg0: $SurfaceRules$RuleSource$$Type): void

(arg0: $SurfaceRules$RuleSource): void
}

export namespace $NoiseGeneratorSettingsAccess {
const probejs$$marker: never
}
export class $NoiseGeneratorSettingsAccess$$Static implements $NoiseGeneratorSettingsAccess {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $NoiseGeneratorSettingsAccess$$Type = ((arg0: $SurfaceRules$RuleSource) => void);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $NoiseGeneratorSettingsAccess_ = $NoiseGeneratorSettingsAccess$$Type;
}}
declare module "net.lyof.phantasm.world.feature.HugeDralgaeFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$DralgaeFeatureConfig, $DralgaeFeatureConfig$$Type} from "net.lyof.phantasm.world.feature.config.DralgaeFeatureConfig"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
import {$TwistingVinesConfig, $TwistingVinesConfig$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.TwistingVinesConfig"
import {$ReplaceSphereConfiguration, $ReplaceSphereConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.ReplaceSphereConfiguration"
import {$BlockStateConfiguration, $BlockStateConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.BlockStateConfiguration"
...
export class $HugeDralgaeFeature extends $Feature<($DralgaeFeatureConfig)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
static readonly "NETHER_FOREST_VEGETATION": $Feature<($NetherForestVegetationConfig)>
static readonly "WEEPING_VINES": $Feature<($NoneFeatureConfiguration)>
static readonly "INSTANCE": $Feature<($DralgaeFeatureConfig)>
static readonly "LAKE": $Feature<($LakeFeature$Configuration)>
static readonly "TWISTING_VINES": $Feature<($TwistingVinesConfig)>
static readonly "END_PLATFORM": $Feature<($NoneFeatureConfiguration)>
static readonly "HUGE_RED_MUSHROOM": $Feature<($HugeMushroomFeatureConfiguration)>
...
constructor(arg0: $Codec$$Type<($DralgaeFeatureConfig$$Type)>)

public "place"(arg0: $FeaturePlaceContext$$Type<($DralgaeFeatureConfig$$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $HugeDralgaeFeature$$Type = ($HugeDralgaeFeature);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $HugeDralgaeFeature_ = $HugeDralgaeFeature$$Type;
}}
declare module "net.lyof.phantasm.block.custom.signs.ModHangingSignBlock" {
import {$WoodType, $WoodType$$Type} from "net.minecraft.world.level.block.state.properties.WoodType"
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$IntegerProperty, $IntegerProperty$$Type} from "net.minecraft.world.level.block.state.properties.IntegerProperty"
...
declare module "net.lyof.phantasm.world.feature.DralgaeFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$DralgaeFeatureConfig, $DralgaeFeatureConfig$$Type} from "net.lyof.phantasm.world.feature.config.DralgaeFeatureConfig"
...
export class $DralgaeFeature extends $Feature<($DralgaeFeatureConfig)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DralgaeFeature$$Type = ($DralgaeFeature);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DralgaeFeature_ = $DralgaeFeature$$Type;
}}
declare module "net.lyof.phantasm.block.custom.PillaringPlantBlock" {
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$Block, $Block$$Type} from "net.minecraft.world.level.block.Block"
import {$Level, $Level$$Type} from "net.minecraft.world.level.Level"
...
export class $PillaringPlantBlock extends $BushBlock implements $BonemealableBlock {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
static readonly "CODEC": $MapCodec<($Block)>
 "shape": $VoxelShape
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $PillaringPlantBlock$$Type = ($PillaringPlantBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $PillaringPlantBlock_ = $PillaringPlantBlock$$Type;
}}
declare module "net.lyof.phantasm.world.feature.ObsidianTowerStructure" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $ObsidianTowerStructure extends $Feature<($CountConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
static readonly "NETHER_FOREST_VEGETATION": $Feature<($NetherForestVegetationConfig)>
static readonly "WEEPING_VINES": $Feature<($NoneFeatureConfiguration)>
static readonly "INSTANCE": $Feature<($CountConfiguration)>
static readonly "LAKE": $Feature<($LakeFeature$Configuration)>
static readonly "TWISTING_VINES": $Feature<($TwistingVinesConfig)>
static readonly "END_PLATFORM": $Feature<($NoneFeatureConfiguration)>
static readonly "HUGE_RED_MUSHROOM": $Feature<($HugeMushroomFeatureConfiguration)>
...
public static "putStairs"(arg0: $WorldGenLevel$$Type, arg1: $BlockPos$$Type): void
public static "putPlatform"(arg0: $WorldGenLevel$$Type, arg1: $BlockPos$$Type, arg2: integer): void
public static "generateRoom"(arg0: $WorldGenLevel$$Type, arg1: $BlockPos$$Type): void
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $ObsidianTowerStructure$$Type = ($ObsidianTowerStructure);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ObsidianTowerStructure_ = $ObsidianTowerStructure$$Type;
}}
declare module "net.lyof.phantasm.block.custom.CrystalShardBlock" {
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$ItemStack, $ItemStack$$Type} from "net.minecraft.world.item.ItemStack"
...
export class $CrystalShardBlock extends $Block implements $SimpleWaterloggedBlock {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
static readonly "CODEC": $MapCodec<($Block)>
static readonly "UPDATE_NEIGHBORS": integer
static readonly "INDESTRUCTIBLE": float
static readonly "IS_TIP": $BooleanProperty
static readonly "OCCLUSION_CACHE": $ThreadLocal<($Object2ByteLinkedOpenHashMap<($Block$BlockStatePairKey)>)>
static readonly "UPDATE_NONE": integer
static readonly "UPDATE_INVISIBLE": integer
static readonly "UPDATE_MOVE_BY_PISTON": integer
...
static readonly "UPDATE_SUPPRESS_DROPS": integer
static readonly "INSTANT": float
static readonly "IS_UP": $BooleanProperty
static readonly "UPDATE_CLIENTS": integer
 "hasCollision": boolean
...
public static "getDirection"(arg0: boolean): $Direction
public "isValidPos"(arg0: $LevelAccessor$$Type, arg1: $BlockPos$$Type, arg2: $Direction$$Type): boolean
public "getStateForPlacement"(arg0: $BlockPlaceContext$$Type): $BlockState
public "neighborChanged"(arg0: $BlockState$$Type, arg1: $Level$$Type, arg2: $BlockPos$$Type, arg3: $Block$$Type, arg4: $BlockPos$$Type, arg5: boolean): void
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CrystalShardBlock$$Type = ($CrystalShardBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $CrystalShardBlock_ = $CrystalShardBlock$$Type;
}}
declare module "net.lyof.phantasm.world.feature.CeilingBoulderFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
import {$TwistingVinesConfig, $TwistingVinesConfig$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.TwistingVinesConfig"
...
export class $CeilingBoulderFeature extends $Feature<($BoulderFeatureConfig)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
public "move"(arg0: $BlockPos$$Type, arg1: $Direction$$Type, arg2: $Direction$$Type, arg3: $RandomSource$$Type, arg4: $WorldGenLevel$$Type): $BlockPos
public "place"(arg0: $FeaturePlaceContext$$Type<($BoulderFeatureConfig$$Type)>): boolean
public "spike"(arg0: $List$$Type<($BlockPos$$Type)>, arg1: $BlockPos$$Type, arg2: integer): void
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $CeilingBoulderFeature$$Type = ($CeilingBoulderFeature);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $CeilingBoulderFeature_ = $CeilingBoulderFeature$$Type;
}}
declare module "net.lyof.phantasm.world.feature.OblivineFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $OblivineFeature extends $Feature<($BlockColumnConfiguration)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
...
static readonly "NETHER_FOREST_VEGETATION": $Feature<($NetherForestVegetationConfig)>
static readonly "WEEPING_VINES": $Feature<($NoneFeatureConfiguration)>
static readonly "INSTANCE": $Feature<($BlockColumnConfiguration)>
static readonly "LAKE": $Feature<($LakeFeature$Configuration)>
static readonly "TWISTING_VINES": $Feature<($TwistingVinesConfig)>
static readonly "END_PLATFORM": $Feature<($NoneFeatureConfiguration)>
static readonly "HUGE_RED_MUSHROOM": $Feature<($HugeMushroomFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $OblivineFeature$$Type = ($OblivineFeature);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $OblivineFeature_ = $OblivineFeature$$Type;
}}
declare module "net.lyof.phantasm.world.feature.config.CrystalSpikeFeatureConfig" {
import {$Codec, $Codec$$Type} from "com.mojang.serialization.Codec"
import {$ConfiguredFeature, $ConfiguredFeature$$Type} from "net.minecraft.world.level.levelgen.feature.ConfiguredFeature"
import {$IntProvider, $IntProvider$$Type} from "net.minecraft.util.valueproviders.IntProvider"
import {$Stream, $Stream$$Type} from "java.util.stream.Stream"
...
export class $CrystalSpikeFeatureConfig extends $Record implements $FeatureConfiguration {
static "CODEC": $Codec<($CrystalSpikeFeatureConfig)>

constructor(size: $IntProvider$$Type, voidChance: float)

public "size"(): $IntProvider
public "equals"(arg0: any): boolean
public "toString"(): StringJS
public "hashCode"(): integer
public "voidChance"(): float
public "getFeatures"(): $Stream<($ConfiguredFeature<(any), (any)>)>
get "features"(): $Stream<($ConfiguredFeature<(any), (any)>)>
}
/**
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CrystalSpikeFeatureConfig$$Type = ({"size"?: $IntProvider$$Type, "voidChance"?: float}) | ([size?: $IntProvider$$Type, voidChance?: float]);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $CrystalSpikeFeatureConfig_ = $CrystalSpikeFeatureConfig$$Type;
}}
declare module "net.lyof.phantasm.world.feature.config.SingleBlockFeatureConfig" {
import {$Codec, $Codec$$Type} from "com.mojang.serialization.Codec"
import {$ConfiguredFeature, $ConfiguredFeature$$Type} from "net.minecraft.world.level.levelgen.feature.ConfiguredFeature"
import {$IntProvider, $IntProvider$$Type} from "net.minecraft.util.valueproviders.IntProvider"
import {$BlockStateProvider, $BlockStateProvider$$Type} from "net.minecraft.world.level.levelgen.feature.stateproviders.BlockStateProvider"
...
export class $SingleBlockFeatureConfig extends $Record implements $FeatureConfiguration {
static "CODEC": $Codec<($SingleBlockFeatureConfig)>

constructor(y: $IntProvider$$Type, state: $BlockStateProvider$$Type)

public "y"(): $IntProvider
public "equals"(arg0: any): boolean
public "toString"(): StringJS
public "hashCode"(): integer
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $SingleBlockFeatureConfig$$Type = ({"y"?: $IntProvider$$Type, "state"?: $BlockStateProvider$$Type}) | ([y?: $IntProvider$$Type, state?: $BlockStateProvider$$Type]);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $SingleBlockFeatureConfig_ = $SingleBlockFeatureConfig$$Type;
}}
declare module "net.lyof.phantasm.block.custom.PomeBlock" {
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$Block, $Block$$Type} from "net.minecraft.world.level.block.Block"
import {$Level, $Level$$Type} from "net.minecraft.world.level.Level"
...
export class $PomeBlock extends $FallingBlock {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
static readonly "CODEC": $MapCodec<($Block)>
static readonly "UPDATE_NEIGHBORS": integer
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $PomeBlock$$Type = ($PomeBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $PomeBlock_ = $PomeBlock$$Type;
}}
declare module "net.lyof.phantasm.block.custom.NihiliumBlock" {
import {$Object2ByteLinkedOpenHashMap, $Object2ByteLinkedOpenHashMap$$Type} from "it.unimi.dsi.fastutil.objects.Object2ByteLinkedOpenHashMap"
import {$Block$BlockStatePairKey, $Block$BlockStatePairKey$$Type} from "net.minecraft.world.level.block.Block$BlockStatePairKey"
import {$Block, $Block$$Type} from "net.minecraft.world.level.block.Block"
import {$Level, $Level$$Type} from "net.minecraft.world.level.Level"
...
export class $NihiliumBlock extends $Block implements $BonemealableBlock {
static readonly "UPDATE_IMMEDIATE": integer
 "item": $Item
static readonly "CODEC": $MapCodec<($Block)>
static readonly "UPDATE_NEIGHBORS": integer
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $NihiliumBlock$$Type = ($NihiliumBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $NihiliumBlock_ = $NihiliumBlock$$Type;
}}
declare module "net.lyof.phantasm.world.feature.CeilingSpikeFeature" {
import {$GeodeConfiguration, $GeodeConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.GeodeConfiguration"
import {$VegetationPatchConfiguration, $VegetationPatchConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.VegetationPatchConfiguration"
import {$SeagrassFeature, $SeagrassFeature$$Type} from "net.minecraft.world.level.levelgen.feature.SeagrassFeature"
import {$SpringConfiguration, $SpringConfiguration$$Type} from "net.minecraft.world.level.levelgen.feature.configurations.SpringConfiguration"
...
export class $CeilingSpikeFeature extends $Feature<($BoulderFeatureConfig)> {
static readonly "VEGETATION_PATCH": $Feature<($VegetationPatchConfiguration)>
static readonly "CHORUS_PLANT": $Feature<($NoneFeatureConfiguration)>
static readonly "MONSTER_ROOM": $Feature<($NoneFeatureConfiguration)>
static readonly "FREEZE_TOP_LAYER": $Feature<($NoneFeatureConfiguration)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CeilingSpikeFeature$$Type = ($CeilingSpikeFeature);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $CeilingSpikeFeature_ = $CeilingSpikeFeature$$Type;
}}
